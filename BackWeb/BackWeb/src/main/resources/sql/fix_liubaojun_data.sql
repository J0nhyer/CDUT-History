...
-- 5. 插入或更新liubaojun的person数据
INSERT INTO `person` (`person_id`, `name`, `subtitle`, `image_url`, `key_tags`, `data_status`, `last_verified`) 
VALUES ('liubaojun', '刘宝珺', '中国科学院院士 · 沉积地质学家 · 成都理工大学名誉校长', '@/assets/persons/liubaojun.png', '["中国科学院院士","沉积地质学奠基人","李四光奖获得者"]', 'completed', '2025-10-30')
...
-- 6. 显示结果
SELECT '=== 修复完成，以下是liubaojun的数据 ===' AS message;
SELECT * FROM person WHERE person_id = 'liubaojun';
SELECT COUNT(*) AS biography_count FROM person_biography WHERE person_id = 'liubaojun';
SELECT COUNT(*) AS relationship_count FROM person_relationship WHERE person_id = 'liubaojun' OR related_person_id = 'liubaojun';
